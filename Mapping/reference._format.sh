#!/bin/bash
#SBATCH --job-name=ref_format_ncbi2
#SBATCH -A dewoody
#SBATCH -t 3-00:00:00 
#SBATCH -p cpu
#SBATCH -N 1 
...
# reference genome formatting: index + dict for mapping (repeatmask/mappability steps below)
...
# # samtools faidx original.fa $(cat autosomes.txt) > original_autosomes.fa
# # samtools faidx original_autosomes.fa
# 
...
# awk '$2 > 100000 { print $1 }' ref.fa.fai > keep.txt
# samtools faidx ref.fa $(cat keep.txt) > ref_100kb.fa
# 
# rm new.fa
# 
...
# 	RepeatMasker -pa 96 -a -qq -species mammals -dir . ref_100kb.fa
# 	 
